...
export const SAFETY_PRESETS: Record<SafetyLevel, SafetyPreset> = {
  safe: {
    ...
    label: "Seguro",
    description:
      "Ideal para contas novas ou que já foram advertidas. Menor risco de banimento.",
  ...
  moderate: {
    ...
    label: "Moderado",
    description:
      "Para contas com mais de 1 mês de uso ativo. Risco médio.",
  ...
  aggressive: {
    ...
    label: "Agressivo",
    description:
      "Para contas antigas (3+ meses). Maior volume, maior risco de banimento.",
