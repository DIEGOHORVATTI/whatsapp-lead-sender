  ...
  override render() {
    ...
    switch (variant) {
      ...
      case 'info':
        ...
        break
      case 'light':
        classNames.push('bg-muted', 'text-foreground', 'hover:bg-accent', 'focus:ring-ring')
        break
      case 'dark':
        classNames.push('bg-foreground', 'text-background', 'hover:opacity-90', 'focus:ring-ring')
        break
    }
